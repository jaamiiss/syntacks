					...
					<div class="col-md-9 blog-box">
						...
						<div class="blog-post image-post">
							...
							<div class="post-head">
                                    ...
                                    <tbody>
                                     	<!-- <c:forEach var="question" items="${listuserquestions}">
                                        <tr class="odd gradeX">
                                            <td>
                                            	<div class="post-content">
													<div class="post-type"><i class="fa fa-picture-o"></i></div>
													<h2><a href="/Syntacks/questions/ask?title=${question.title}&content=${question.content}&tags=${question.tags}">${question.title}</a></h2>
													<ul class="post-meta">
														<li>By <a href="#">iThemesLab</a></li>
														<li>${question.date_time}</li>
														<li>
                                        ...
                                        <tr class="odd gradeX">
                                            <td>
                                            	<div class="post-content">
													<div class="post-type"><i class="fa fa-picture-o"></i></div>
													<h2><a href="/Syntacks/questions/ask?action=Update%20Question&title_id=${question.title_id}&title=${question.title}&content=${question.content}&tags=${question.tags}">${question.title}</a></h2>
													<ul class="post-meta">
														<li>By <a href="#">iThemesLab</a></li>
														<li>${question.date_time}</li>
														<li>
