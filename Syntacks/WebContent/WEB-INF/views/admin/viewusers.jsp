				...
				<div class="row blog-page">
					...
					<div class="col-md-3 sidebar left-sidebar">
						...
						<div class="widget widget-categories">
							...
							<ul>
								<li>
									<a href="view-questions">Questions</a>
								</li>
								<li>
					...
					<div class="col-md-9 blog-box">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>${user.email}</td>
                                            <td>${user.enabled}</td>
                                            <td><a href=""><button type="submit" class="btn btn-danger">Ban</button></a>
                                            <a href=""><button type="submit" class="btn btn-success">UnBan</button></a>
                                             <a href="/Syntacks/delete?id=${user.id}" name="delete"><button type="submit" class="btn btn-success">Delete</button></a>
                                            </td>
                                        </tr>
                                       	</c:forEach>
                                    </tbody>
